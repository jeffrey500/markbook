...
public class Client {
    public static void main(String[] args) {
        ...
        String classCode = JOptionPane.showInputDialog(null, "Let's create your first classroom!\nWhat is the class code?", "Markbock", 3);
        String firstStudent = JOptionPane.showInputDialog(null, "Let's move on to adding students!\nWhat is the first name of your first student in you first row?", "Markbock", 3);
        String firstStudentMarksSTR = JOptionPane.showInputDialog(null, "Give us a list of marks of that first student! (decimals allowed)\nNote that non-numbers will be rejected, <0 = 0, >100 = 100");
        double[] firstStudentsMarks = idk(firstStudentMarksSTR);
        var yesOrNo = JOptionPane.showOptionDialog(null, "What would you like to do?", "Markbock",
        ...
        if (yesOrNo == 0) {
            ...
            String studMarks = JOptionPane.showInputDialog(null, "Give us a list of marks of that first student! (decimals allowed)\nNote that non-numbers will be rejected, <0 = 0, >100 = 100");
            ...
            while (repeat == true) {
                ...
                var repeatmenu = JOptionPane.showOptionDialog(null, "What would you like to do?", "Markbock",
                        JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, repeat1, repeat1[0]);

                if (repeatmenu == 0){
                    String studName1 = JOptionPane.showInputDialog(null, "What is the first name of your first student in the row?", "Markbock", 3);
                    String studMarks1 = JOptionPane.showInputDialog(null, "Give us a list of marks of that first student! (decimals allowed)\nNote that non-numbers will be rejected, <0 = 0, >100 = 100");
                    listOfCLasses.get(0).addStudentInRow(new Student(studName1, idk(studMarks1)));
                } else if(repeatmenu == 1){
                    String studName1 = JOptionPane.showInputDialog(null, "What is the first name of the student", "Markbock", 3);
                    String studMarks1 = JOptionPane.showInputDialog(null, "Give us a list of marks of that first student! (decimals allowed)\nNote that non-numbers will be rejected, <0 = 0, >100 = 100");
    ...
    public static void normalOperation(ArrayList<ClassList> listOfClasses) {
        ...
        while (repeat == true) {
            ...
            var yesOrNo = JOptionPane.showOptionDialog(null, "What would you like to do?", "Markbock",
                    JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, menuButtons, menuButtons[0]);
            ...
            if (yesOrNo == 0) {
                ...
                if (findClassList(listOfClasses, inputClassCode) != null) {
                    ...
                    var classMenu = JOptionPane.showOptionDialog(null, "What would you like to do?", "Markbock",
                            JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, classMenuButtons, classMenuButtons[0]);


                    if (classMenu == 0) {
                        String[] modifyOrAccessGrades = {"access a student statistic", "Modify a grade from a student"};
                        var modifyOrAccessGradesMenu = JOptionPane.showOptionDialog(null, "What would you like to do?", "Markbock",
                                JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, modifyOrAccessGrades, modifyOrAccessGrades[0]);


                        if (modifyOrAccessGradesMenu == 0) {
                            String[] studentStatistic = {"get student average", "get student median", "show all grades"};
                            var studentStatisticMenu = JOptionPane.showOptionDialog(null, "What would you like to do?", "Markbock",
                                    JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, studentStatistic, studentStatistic[0]);
                            ...
                            if (studentStatisticMenu == 0) {
                                ...
                                JOptionPane.showMessageDialog(null, inputStudent + " has an average of " + findStudent(inputStudent, findClassList(listOfClasses, inputClassCode)).getAverageMark() + "%");


                            } else if (studentStatisticMenu == 1) {
                                String inputStudent = JOptionPane.showInputDialog(null, "Type the name of the student", "Markbock", 3);
                                JOptionPane.showMessageDialog(null, inputStudent + " has a median " + findStudent(inputStudent, findClassList(listOfClasses, inputClassCode)).getMedian());
                            ...
                            var modifyGradesMenu = JOptionPane.showOptionDialog(null, "What would you like to do?", "Markbock",
                                    JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, modifyGrades, modifyGrades[0]);


                            if (modifyGradesMenu == 0) {
                                String inputStudent = JOptionPane.showInputDialog(null, "Type the name of the student", "Markbock", 3);
                                String gradeInput = JOptionPane.showInputDialog(null, "What percentage grade would you like to add\ndeciamls allowed only numbers!", "Markbock", 3);
                                try {
                        ...
                        var classStatsMenu = JOptionPane.showOptionDialog(null, "What would you like to do?", "Markbock",
                                JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, classStats, classStats[0]);
                        if (classStatsMenu == 0) {
                            JOptionPane.showMessageDialog(null, "The class average mark is " + findClassList(listOfClasses, inputClassCode).getAverageMark(), "Markbock", 3);


                        } else {
                            JOptionPane.showMessageDialog(null, "The class Median mark is " + findClassList(listOfClasses, inputClassCode).getMedianMark(), "Markbock", 3);
                        }


                    } else {
                        String[] addAndRemove = {"Add a student", "remove a student"};
                        var addAndRemoveMenu = JOptionPane.showOptionDialog(null, "What would you like to do?", "Markbock",
                                JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, addAndRemove, addAndRemove[0]);
                        if (addAndRemoveMenu == 0) {
                            String addStudent = JOptionPane.showInputDialog(null, "Where would you like to add the student type row then column \n" + findClassList(listOfClasses, inputClassCode).printClassroom(), "Markbock", 3);
